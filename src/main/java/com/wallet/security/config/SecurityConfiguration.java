...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	//quando for bean será gerenciado pelos containers do spring
    ...
    protected void configure(HttpSecurity http) throws Exception{
    	...
    	.antMatchers("/auth/**", "/configuration/security", "/webjars/**", "/users/**", "/v2/api-docs", "/swagger-resources/**", "/swagger-ui.html", "/hello-world")
